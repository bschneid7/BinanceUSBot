...
async function testResumeTrading(justification) {
    console.log('\n=== Resume Trading ===\n');
    try {
...
async function testGetAlerts() {
    ...
    try {
        ...
        const emergencyStopAlert = alerts.find((a) => a.type === 'EMERGENCY_STOP');
        const resumeAlert = alerts.find((a) => a.type === 'TRADING_RESUMED');
...
//# sourceMappingURL=testBotControlEndpoints.js.map